...
class DatabaseDAO:
    ...
    def search_for_title(self, title) -> list[dict[str, str | int]]:
    ...
    def search_by_years_range(self, year_1, year_2) -> list[dict[str, str | int]]:
        query = f"""
    ...
    def search_by_rating(self, rating_group: str) -> list[dict[str, str]]:
